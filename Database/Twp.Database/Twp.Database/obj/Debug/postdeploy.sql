...
BEGIN TRY
	BEGIN TRANSACTION ADD_PERMISSIONS_ROLE_TYPE
		...
		BEGIN
			...
			SELECT PermissionId, @ROLE_USER, ValueToUse FROM @DEFAULT_USER_PERMISSIONS_TO_ADD
		END
...
BEGIN TRY
	BEGIN TRANSACTION ADD_PERMISSIONS_ROLE_TYPE
		...
		BEGIN
			INSERT INTO RoleTypePermission (PermissionId, RoleTypeId, [Value])
			SELECT PermissionId, @ROLE_USER, ValueToUse FROM @LABOR_USER_PERMISSIONS_TO_ADD
		END
...
BEGIN TRY
	BEGIN TRANSACTION ADD_PERMISSIONS_ROLE_TYPE
		...
		BEGIN
			INSERT INTO RoleTypePermission (PermissionId, RoleTypeId, [Value])
			SELECT PermissionId, @ROLE_USER, ValueToUse FROM @SYSTEM_ADMIN_PERMISSIONS_TO_ADD
		END
...
BEGIN TRY
	BEGIN TRANSACTION ADD_PERMISSIONS_ROLE_TYPE
		...
		BEGIN
			INSERT INTO RoleTypePermission (PermissionId, RoleTypeId, [Value])
			SELECT PermissionId, @ROLE_USER, ValueToUse FROM @TERMINAL_ADMIN_PERMISSIONS_TO_ADD
		END
